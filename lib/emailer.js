...
async function sendReservationConfirmation(reg, cohort) {
  ...
  const products = [
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#EFE7D8;border-radius:0 0 16px 0;margin:0 0 12px;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f0d0a;"><tr><td align="center" style="padding:0;">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
      ...
      <tr><td style="background:#EFE7D8;padding:36px 44px 30px;" class="fs-pad">
        <p style="margin:0 0 16px;font-family:'Inter',Arial,sans-serif;font-size:15px;line-height:1.7;color:#2A2826;">Hi ${reg.first_name},</p>
        <p style="margin:0 0 22px;font-family:'Inter',Arial,sans-serif;font-size:15px;line-height:1.7;color:#2A2826;">Thanks for reserving your <strong style="color:#1A1A1A">${trackLabel}</strong> place — it's saved to your account, and <strong style="color:#1A1A1A">you haven't been charged anything today.</strong></p>
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#E6DCC7;border-radius:0 0 20px 0;margin:0 0 22px;">
          <tr><td style="height:3px;line-height:3px;font-size:0;background:#C8531F;">&nbsp;</td></tr>
      ...
      <tr><td style="background:#E6DCC7;padding:34px 44px;" class="fs-pad">
