...
async function sendFinancePaymentRecord(reg, cohort, paymentType, meta = {}) {
  ...
  const bodyHtml = `
    ...
    <p style="margin:18px 0 0;font-family:'Inter',Arial,sans-serif;font-size:12px;line-height:1.6;color:#5A564F;">Automated record for finance. QuickBooks Online sync will take over once the company bank account is connected.</p>`;
